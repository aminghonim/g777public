...
- **التاريخ:** 2026-01-20
- **المشكلة:** تعارض أسماء الحاويات عند التشغيل.
...
- **التاريخ:** 2026-03-03
- **المشكلة:** فشل الاتصال بقاعدة البيانات رغم صحة الباسوورد (`100200300aA@wfccfllcbnlepudnokpu`) عند وضعها in `DATABASE_URL`.
- **السبب الجذري:**
