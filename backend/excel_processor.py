...
class ExcelProcessor:
    ...
    def get_sheets(self, excel_path: str) -> List[str]:
        ...
        try:
            ...
            print(f"[ERROR] فشل قراءة الأوراق عبر pandas: {e}")
            ...
            try:
                ...
                print(f"[CRITICAL] فشل كلي في قراءة هيكل الملف: {ex}")
                return []
    ...
    def get_columns(self, excel_path: str, sheet_name: Any = 0) -> List[str]:
        ...
        try:
            ...
            print(f"[ERROR] فشل قراءة الأعمدة: {e}")
            return []
    ...
    def read_contacts(self, excel_path: str, sheet_name: Any = 0, 
        ...
        try:
            ...
            print(f"[OK] تم تحميل {len(contacts)} جهة اتصال")
            return contacts
