...
class UIDesigner:
    ...
    def _build_design_prompt(
        ...
        style_guidelines = {
            ...
            """,
            "dark": """
                - استخدم خلفية داكنة متناسقة (مثل الأسود العميق أو الكحلي الداكن)
                - نصوص واضحة وعالية التباين
                - تأثيرات ضوئية خفيفة (subtle glow)
                - contrasts احترافية
            """,
            "glassmorphism": """
...
8. **قاعدة Theme-Agnostic:** لا تفترض أبداً أن الخلفية يجب أن تكون سوداء أو داكنة بشكل افتراضي. استمد الألوان والسمات البصرية حصراً من "الوصف" أو "نظام الألوان" المقدم. إذا طُلب تصميم فاتح (Light)، نفذه بدقة. أنت منفذ محايد لـ Design Tokens.
