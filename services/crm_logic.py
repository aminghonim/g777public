...
This module contains all CRM business logic separated from the UI (Flutter).
...
class CRMService:
    ...
    def add_tag(customer: Dict, tag: str) -> Dict:
        ...
        interests_missing = 'interests' not in customer['metadata']
        if interests_missing or not isinstance(customer['metadata']['interests'], list):
